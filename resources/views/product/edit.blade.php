        ...
        <div class="card-body">
            <form method="POST" action="{{ route('update_product') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ $product->description }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="amount_stock" type="text" class="form-control{{ $errors->has('amount_stock') ? ' is-invalid' : '' }}" name="amount_stock" value="{{ $product->amount_stock }}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="amount_ratings" type="text" class="form-control{{ $errors->has('amount_ratings') ? ' is-invalid' : '' }}" name="amount_ratings" value="{{ $product->amount_ratings }}" required>
